...
import os, time, json, random, asyncio, aiohttp
...
async def VidWatermarkAdder(bot, cmd):
	...
	output_vid = main_file_name + "_[" + str(cmd.from_user.id) + "]_[" + str(time.time()) + "]_[@anondeveloper]" + ".mp4"
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Devsoops).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
